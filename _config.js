module.exports = {
  ...
  title: `White.Ink`,                           // (* Required)
  description: `Data and Tech Blog`,          // (* Required)
  author: `Neil Brockett`,                         // (* Required)
  language: 'en',                        // (* Required) html lang, ex. 'en' | 'en-US' | 'ko' | 'ko-KR' | ...
  siteUrl: 'https://nbrockett.github.io',                      // (* Required)
  ...
  github: 'https://github.com/nbrockett',                                                            // ex.'https://github.com/junhobaik'
